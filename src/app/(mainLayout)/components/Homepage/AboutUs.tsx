...
export default function AboutUs() {
  return (     
    <section className="primary-container  justify-between  items-stretch  mx-auto py-12  lg:py-16 flex flex-col-reverse lg:flex-row   space-y-8 lg:space-y-0 lg:space-x-8">
      {/* Image Column */}
